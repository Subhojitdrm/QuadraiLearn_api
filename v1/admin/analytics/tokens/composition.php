...
try {
    ...
    $composition = get_token_composition($pdo, $from, $to);
    ...
    error_log('Database error in analytics composition: ' . $e->getMessage());
    send_error('database_error', 'A database error occurred', [], 500);
} catch (Exception $e) {
    error_log('Error in analytics composition: ' . $e->getMessage());
